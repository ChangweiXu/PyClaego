...
from .parser import parse_skill_file, parse_sections, extract_summary, validate_metadata
from .exceptions import SkillInvalidError, SkillLoadError, SectionNotFoundError
...
class Skill:
    ...
    def __init__(self, skill_path: Path):
        ...
        self.argument_hint: Optional[str] = None
