...
from .types import (
    ContentPart, DocumentPart, ImagePart, TextPart,
    ToolCall, ToolDefinition, UnifiedMessage, ChatResponseV2,
)
...
class GeminiClient(LLMClient):
    ...
    async def chat_completion_v2(
        ...
        **kwargs,
        ...
        try:
            ...
            error_msg = f"Gemini API 调用失败 (v2): {str(e)}"
    ...
    def _parse_response(self, response: genai_types.GenerateContentResponse) -> ChatResponseV2:
        ...
        if response.candidates and response.candidates[0].content and response.candidates[0].content.parts:
            for part in response.candidates[0].content.parts:
                ...
                if part.function_call:
                    ...
                    thought_sig: Optional[bytes] = None
        ...
        return ChatResponseV2(
            ...
            produced_by_model=getattr(response, "model_version", None) or self.model,
        )
