...
class SimpleAgent(BaseAgent):
    ...
    def __init__(self, config: dict[str, Any], session_id: str):
        ...
        agent_type = agent_config.get("type", "spawn")
    ...
    ) -> tuple[str | None, list[UnifiedMessage], list[ToolDefinition] | None]:
    ...
    async def _execute_tool_calls(
        ...
        tool_calls: list[ToolCall],
        round_index: int,
        loop_handler: SessionTaskHandler | None = None,
    ) -> list[ToolCallResult]:
