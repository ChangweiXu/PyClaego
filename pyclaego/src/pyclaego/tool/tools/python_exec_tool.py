...
class PythonExecTool(BaseTool):
    ...
    - 自动使用当前进程的 Python 解释器（sys.executable）
    - 支持超时控制
    ...
    def __init__(self, tool_config: dict[str, Any]):
        ...
        self.working_dir: str | None = tool_config.get("working_dir")
    ...
    async def execute(self, **kwargs) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(status=ToolStatus.FAILED, error=f"执行异常: {e!s}")
        finally:
    ...
    def get_description(self) -> dict[str, Any]:
        return {
            ...
            "config": {
                "python_path": self.python_path,  # auto-detected via sys.executable
