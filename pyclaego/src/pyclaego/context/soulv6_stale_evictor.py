...
from .soulv6_tool_result_store import SoulV6StoredArtifact, SoulV6ToolResultStore
...
class SoulV6EvictDecision:
    ...
    replacement_text: str | None = None  # action != KEEP 时的新文本
...
class SoulV6StaleEvictor:
    ...
    def decide(
        ...
        pinned_tool_call_ids: set[str] | None = None,
        referenced_tool_call_ids: set[str] | None = None,
        ...
        for idx, msg in enumerate(messages):
            ...
            for tr in tool_results:
                ...
                artifact: SoulV6StoredArtifact | None = self._store.get_artifact(tool_call_id)
    ...
    def _decide_one(
        ...
        *,
        ...
        artifact: SoulV6StoredArtifact | None,
    ) -> SoulV6EvictDecision:
        # Rule 1: pinned → KEEP
        if is_pinned:
