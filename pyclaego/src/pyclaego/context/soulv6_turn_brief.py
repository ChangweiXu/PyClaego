...
class SoulV6TurnBriefSynthesizer:
    ...
    _instance: SoulV6TurnBriefSynthesizer | None = None

    def __init__(self, memory_manager: SoulV6MemoryManager | None = None) -> None:
    ...
    async def _call_llm(self, session_task_handler: SessionTaskHandlerV2, transcript: str) -> str | None:
        if not session_task_handler:
            raise ValueError("SessionTaskHandlerV2 未设置")
